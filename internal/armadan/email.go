...
https://armadan.se/reset-password?token=%s
...
<body style="font-family: Arial, sans-serif; padding: 20px;">
	...
	<a href="https://armadan.se/reset-password?token=%s" class="button" style="display: inline-block; padding: 10px 20px; color: #ffffff; background: #000000; text-decoration: none; border-radius: 5px;">Återställ lösenord</a>
